...
as a L2, the Kroma-network does not serve blobs, and thus disables this new transaction type.
...
With the adoption of [EIP-4399] in the genesis the Kroma-network already includes the `PREVRANDAO` of L1.
